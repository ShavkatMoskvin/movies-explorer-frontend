            ...
            <form class="register__form" name="register" onSubmit={handleSubmit} novalidate=""><a class="register__link" href="/">
                ...
                <div class="register__labels-container">
                    ...
                    <label class="register__label">
                        ...
                        <input onChange={handleInputChange} name="email" pattern="[A-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class={`register__input ${errors.email ? 'register__error_input' : ''}`} type="email" required /><span class="register__error">{errors.email}</span>
                    </label>
                    <label class="register__label">
